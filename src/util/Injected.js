...
exports.ExposeStore = (moduleRaidStr) => {
  ...
  window.Store.GroupMetadata.queryAndUpdate = window.mR.findModule(
  ...
  window.Store.ContactCollection =
    window.mR.findModule("ContactCollection")[0].ContactCollection;
  ...
  window.Store.BusinessProfileCollection = window.mR.findModule(
    "BusinessProfileCollection"
  )[0].BusinessProfileCollection;
  ...
  window.injectToFunction(
    {
      moduleId: "mediaTypeFromProtobuf",
      index: 0,
  ...
  window.injectToFunction(
    {
      moduleId: "typeAttributeFromProtobuf",
      index: 0,
...
exports.LoadUtils = () => {
  ...
  window.WWebJS.getContact = async (contactId) => {
    ...
    const bizProfile =
      await window.Store.BusinessProfileCollection.fetchBizProfile(wid);
  ...
  window.WWebJS.cropAndResizeImage = async (media, options = {}) => {
    ...
    options = Object.assign(
      { size: 640, mimetype: media.mimetype, quality: 0.75, asDataUrl: false },
      options
    );
